...
export default function NewActivityPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">新建活动</h1>
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 max-w-3xl space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input type="text" value={form.date} onChange={(e) => updateField('date', e.target.value)} placeholder="如 2026-04-15" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
